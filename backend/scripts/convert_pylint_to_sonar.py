...
def convert_pylint_to_sonar(pylint_json_path, sonar_json_output_path):
    ...
    try:
        ...
        print(f"✅ Successfully converted Pylint report to SonarQube format: {sonar_json_output_path}")
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python convert_pylint_to_sonar.py <pylint_json_input> <sonar_json_output>")
        sys.exit(1)
